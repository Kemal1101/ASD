...
public class ScavengerMain {
    public static void main(String[] args) {
        ...
        game.addPoint("Sederhanakan 2(3x-4)+3(3x+5)", "15x+7");
        game.addPoint("Sederhanakan 6a+7b-5c+2a-3b+7c", "8a+4b+2c");
        ...
        while (game.head != null) {
            ...
            } else if(answer.equalsIgnoreCase("Kembali")){
                game.kembali();
                System.out.println("Berhasil Kembali ke Soal Sebelumnya");
            }else {
